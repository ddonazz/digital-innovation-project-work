...
\begin{tabularx}{\linewidth}{
    >{\raggedright\arraybackslash}p{0.22\linewidth} % Prima colonna un po' più stretta
    >{\raggedright\arraybackslash}X                 % Seconda colonna si espande
    >{\raggedright\arraybackslash}X                 % Terza colonna si espande
}
\toprule
